...
namespace Jellyfin.Server.Implementations.Events.Consumers.System
{
    ...
    /// </summary>
    public class UpdateAvailablePluginNotifier : IEventConsumer<UpdateAvailableEventArgs>
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateAvailablePluginNotifier"/> class.
        /// </summary>
        ...
        public UpdateAvailablePluginNotifier(
