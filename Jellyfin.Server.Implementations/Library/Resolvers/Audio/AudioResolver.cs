...
namespace Jellyfin.Server.Implementations.Library.Resolvers.Audio
{
    ...
    /// Class AudioResolver
    /// </summary>
    public class AudioResolver : ItemResolver<Jellyfin.Controller.Entities.Audio.Audio>, IMultiItemResolver
    {
            ...
            IDirectoryService directoryService)
        {
            ...
            if (result != null)
            {
                ...
                {
                    SetInitialItemValues((Jellyfin.Controller.Entities.Audio.Audio)item, null);
                }
            }
        ...
        protected override Jellyfin.Controller.Entities.Audio.Audio Resolve(ItemResolveArgs args)
        {
            ...
            if (LibraryManager.IsAudioFile(args.Path, libraryOptions))
            {
                ...
                Jellyfin.Controller.Entities.Audio.Audio item = null;
                ...
                {
                    item = new Jellyfin.Controller.Entities.Audio.Audio();
                }
        ...
        private T FindAudio<T>(ItemResolveArgs args, string path, Folder parent, List<FileSystemMetadata> fileSystemEntries, IDirectoryService directoryService, string collectionType, bool parseName)
            where T : Jellyfin.Controller.Entities.Audio.Audio, new()
        {
