...
public sealed partial class BaseItemRepository
{
    ...
    // Artists are matched by the credits pointing at them, genres and studios by the values their
    // items carry. Exactly one of itemValueTypes and personKinds applies.
