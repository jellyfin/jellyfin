...
using Jellyfin.Notifications;
using Jellyfin.Photos;
using Jellyfin.Server.Implementations.Activity;
using Jellyfin.Server.Implementations.Archiving;
using Jellyfin.Server.Implementations.Channels;
using Jellyfin.Server.Implementations.Collections;
using Jellyfin.Server.Implementations.Configuration;
using Jellyfin.Server.Implementations.Cryptography;
using Jellyfin.Server.Implementations.Data;
using Jellyfin.Server.Implementations.Devices;
using Jellyfin.Server.Implementations.Diagnostics;
...
using Jellyfin.Server.Implementations.LiveTv;
...
using Jellyfin.Server.Implementations.ScheduledTasks;
using Jellyfin.Server.Implementations.Security;
using Jellyfin.Server.Implementations.Serialization;
using Jellyfin.Server.Implementations.Session;
using Jellyfin.Server.Implementations.SocketSharp;
using Jellyfin.Server.Implementations.TV;
using Jellyfin.Server.Implementations.Updates;
using Jellyfin.Api;
using Jellyfin.Common;
using Jellyfin.Common.Configuration;
using Jellyfin.Common.Events;
using Jellyfin.Common.Extensions;
using Jellyfin.Common.Net;
using Jellyfin.Common.Plugins;
using Jellyfin.Common.Updates;
using Jellyfin.Controller;
using Jellyfin.Controller.Authentication;
using Jellyfin.Controller.Channels;
using Jellyfin.Controller.Chapters;
using Jellyfin.Controller.Collections;
...
using Jellyfin.Controller.Notifications;
...
using Jellyfin.Controller.Resolvers;
...
using Jellyfin.MediaEncoding.BdInfo;
using Jellyfin.Model.Activity;
using Jellyfin.Model.Configuration;
using Jellyfin.Model.Cryptography;
...
using Jellyfin.Model.System;
using Jellyfin.Model.Tasks;
using Jellyfin.Model.Updates;
using Jellyfin.Providers.Chapters;
using Jellyfin.Providers.Manager;
using Jellyfin.Providers.Subtitles;
using Jellyfin.Providers.TV.TheTVDB;
using Jellyfin.WebDashboard.Api;
using Jellyfin.XbmcMetadata.Providers;
...
using ServiceStack;
using OperatingSystem = Jellyfin.Common.System.OperatingSystem;
...
namespace Jellyfin.Server.Implementations
{
    ...
    public abstract class ApplicationHost : IServerApplicationHost, IDisposable
    {
        ...
        protected async Task RegisterResources(IServiceCollection serviceCollection)
        {
            ...
            MediaEncoder = new Jellyfin.MediaEncoding.Encoder.MediaEncoder(
                LoggerFactory,
                JsonSerializer,
            ...
            SubtitleEncoder = new Jellyfin.MediaEncoding.Subtitles.SubtitleEncoder(LibraryManager, LoggerFactory, ApplicationPaths, FileSystemManager, MediaEncoder, JsonSerializer, HttpClient, MediaSourceManager, ProcessFactory);
        ...
        protected IEnumerable<Assembly> GetComposablePartAssemblies()
        {
            ...
            // MediaEncoding
            yield return typeof(Jellyfin.MediaEncoding.Encoder.MediaEncoder).Assembly;
