...
using IHttpFile = Jellyfin.Model.Services.IHttpFile;
using IHttpRequest = Jellyfin.Model.Services.IHttpRequest;
using IResponse = Jellyfin.Model.Services.IResponse;
