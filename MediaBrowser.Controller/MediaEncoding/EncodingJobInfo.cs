...
public class EncodingJobInfo
{
    ...
    private TranscodeReason? _transcodeReasons;
    ...
    public string[] GetRequestedProfiles(string codec)
    {
        ...
        {
            return BaseRequest.Profile.Split(['|', ','], StringSplitOptions.RemoveEmptyEntries);
        }
        ...
        if (!string.IsNullOrEmpty(codec))
        {
            ...
            {
                return profile.Split(['|', ','], StringSplitOptions.RemoveEmptyEntries);
            }
        }
    ...
    public string[] GetRequestedRangeTypes(string codec)
    {
        ...
        {
            return BaseRequest.VideoRangeType.Split(['|', ','], StringSplitOptions.RemoveEmptyEntries);
        }
        ...
        if (!string.IsNullOrEmpty(codec))
        {
            ...
            {
                return rangetype.Split(['|', ','], StringSplitOptions.RemoveEmptyEntries);
            }
        }
    ...
    public string[] GetRequestedCodecTags(string codec)
    {
        ...
        {
            return BaseRequest.CodecTag.Split(['|', ','], StringSplitOptions.RemoveEmptyEntries);
        }
        ...
        if (!string.IsNullOrEmpty(codec))
        {
            ...
            {
                return codectag.Split(['|', ','], StringSplitOptions.RemoveEmptyEntries);
            }
        }
