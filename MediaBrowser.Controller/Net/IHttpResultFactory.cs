...
namespace MediaBrowser.Controller.Net
{
    ...
    public interface IHttpResultFactory
    {
        ...
        object GetResult(byte[] content, string contentType, IDictionary<string,string> responseHeaders = null);

        object GetResult(Stream content, string contentType, IDictionary<string, string> responseHeaders = null);
