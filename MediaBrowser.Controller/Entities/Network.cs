...
namespace MediaBrowser.Controller.Entities
{
    ...
    public class Network : BaseItem, IItemByName
    {
        /// <summary>
        ...
        public static string GetPath(string name, bool normalizeName)
        {
            ...
            return System.IO.Path.Combine(ConfigurationManager.ApplicationPaths.NetworkPath, validName);
        }
