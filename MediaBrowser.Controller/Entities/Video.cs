...
namespace MediaBrowser.Controller.Entities
{
        ...
        IHasMediaSources
    {
        ...
        [JsonIgnore] public string PrimaryVersionId { get; set; }
        ...
        [JsonIgnore] public override bool SupportsPeople => true;
        ...
        [JsonIgnore] public bool IsStacked => AdditionalParts.Length > 0;

        [JsonIgnore] public override bool HasLocalAlternateVersions => LocalAlternateVersions.Length > 0;
        ...
        [JsonIgnore] protected virtual bool EnableDefaultVideoUserDataKeys => true;
        ...
        public override IEnumerable<FileSystemMetadata> GetDeletePaths()
        {
            if (!IsInMixedFolder)
            {
                return new[] {new FileSystemMetadata {FullName = ContainingFolderPath, IsDirectory = true}};
            }
        ...
        public virtual MediaStream GetDefaultVideoStream()
        {
            ...
            return MediaSourceManager.GetMediaStreams(new MediaStreamQuery {ItemId = Id, Index = DefaultVideoStreamIndex.Value}).FirstOrDefault();
        }
