...
public abstract class BaseItem : IHasProviderIds, IHasLookupInfo<ItemLookupInfo>, IEquatable<BaseItem>
{
    ...
    public virtual bool IsAuthorizedToDelete(User user, IReadOnlyCollection<Folder> allCollectionFolders)
    {
    ...
    public bool CanDelete(User user, IReadOnlyCollection<Folder> allCollectionFolders)
    {
    ...
    {
        return [DateLastSaved.Ticks.ToString(CultureInfo.InvariantCulture)];
    }
