...
namespace MediaBrowser.Controller.Entities
{
    ...
    public abstract class BaseItem : IHasProviderIds, IHasLookupInfo<ItemLookupInfo>, IEquatable<BaseItem>
    {
        ...
        public virtual bool IsPlayed(User user, UserItemData userItemData = null)
        {
        ...
        public bool IsFavoriteOrLiked(User user, UserItemData userItemData = null)
        {
            userItemData ??= UserDataManager.GetUserData(user, this);
        ...
        public virtual bool IsUnplayed(User user, UserItemData userItemData = null)
        {
            ArgumentNullException.ThrowIfNull(user);
