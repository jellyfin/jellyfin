...
# Build archives
dotnet publish --configuration Release --self-contained false --output /dist/jellyfin_${version}/ "-p:GenerateDocumentationFile=false;DebugSymbols=false;DebugType=none"
