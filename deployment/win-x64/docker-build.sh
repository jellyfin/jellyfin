...
# Build binary
dotnet publish --configuration Release --self-contained true --runtime win-x64 --output /dist/jellyfin_${version}/ "-p:GenerateDocumentationFile=false;DebugSymbols=false;DebugType=none"
