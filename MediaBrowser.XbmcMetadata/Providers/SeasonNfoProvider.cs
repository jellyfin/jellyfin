...
namespace MediaBrowser.XbmcMetadata.Providers
{
    ...
    public class SeasonNfoProvider : BaseNfoProvider<Season>
    {
        ...
        /// <inheritdoc />
        protected override async Task Fetch(MetadataResult<Season> result, string path, CancellationToken cancellationToken)
        {
            await new SeasonNfoParser(_logger, _config, _providerManager, _userManager, _userDataManager, _genreManager, _directoryService).Fetch(result, path, cancellationToken).ConfigureAwait(false);
        }
