...
namespace MediaBrowser.XbmcMetadata.Providers
{
    ...
    public class SeriesNfoProvider : BaseNfoProvider<Series>
    {
        ...
        /// <inheritdoc />
        protected override async Task Fetch(MetadataResult<Series> result, string path, CancellationToken cancellationToken)
        {
            await new SeriesNfoParser(_logger, _config, _providerManager, _userManager, _userDataManager, _genreManager, _directoryService).Fetch(result, path, cancellationToken).ConfigureAwait(false);
        }
