...
namespace MediaBrowser.XbmcMetadata.Providers
{
    ...
    public class ArtistNfoProvider : BaseNfoProvider<MusicArtist>
    {
        ...
        /// <inheritdoc />
        protected override async Task Fetch(MetadataResult<MusicArtist> result, string path, CancellationToken cancellationToken)
        {
            await new BaseNfoParser<MusicArtist>(_logger, _config, _providerManager, _userManager, _userDataManager, _genreManager, _directoryService).Fetch(result, path, cancellationToken).ConfigureAwait(false);
        }
