    ...
    public class WebSocketManager : IWebSocketManager
    {
        ...
        public async Task WebSocketRequestHandler(HttpContext context)
        {
            ...
            try
            {
                ...
                // Capture the culture context set by AcceptLanguageMiddleware
                // so it can be restored when processing incoming WebSocket messages.
                var cultureFallback = LocalizationManager.RequestCultureFallback;
                    ...
                    context.GetNormalizedRemoteIP())
                {
                    OnReceive = result =>
                    {
                        LocalizationManager.RequestCultureFallback = cultureFallback;
