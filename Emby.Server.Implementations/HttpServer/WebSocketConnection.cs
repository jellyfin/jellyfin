...
namespace Emby.Server.Implementations.HttpServer
{
    ...
    public class WebSocketConnection : IWebSocketConnection
    {
        ...
        [Message(typeof(SyncPlayGroupUpdateCommandOfGroupInfoMessage))]
        [Message(typeof(SyncPlayGroupUpdateCommandOfGroupStateUpdateMessage))]
        [Message(typeof(SyncPlayGroupUpdateCommandOfPlayQueueUpdateMessage))]
        [Message(typeof(SyncPlayGroupUpdateCommandOfStringMessage))]
