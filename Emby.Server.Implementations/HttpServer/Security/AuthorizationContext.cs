            ...
            if (!string.IsNullOrWhiteSpace(token))
            {
                ...
                if (originalAuthenticationInfo != null)
                {
                    ...
                    if (!originalAuthenticationInfo.UserId.Equals(Guid.Empty))
                    {
                        ...
                        if (authInfo.User != null && !string.Equals(authInfo.User.Name, originalAuthenticationInfo.UserName, StringComparison.OrdinalIgnoreCase))
                        {
                            originalAuthenticationInfo.UserName = authInfo.User.Name;
                            updateToken = true;
                        }
                    }
