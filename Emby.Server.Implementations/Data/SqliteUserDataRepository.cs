...
namespace Emby.Server.Implementations.Data
{
    ...
    public class SqliteUserDataRepository : BaseSqliteRepository, IUserDataRepository
    {
        ...
        public UserItemData GetUserData(long internalUserId, string key)
        {
            ...
            return statement.ExecuteQuery().Select(ReadRow).FirstOrDefault();
        }
        ...
        public UserItemData GetUserData(long internalUserId, List<string> keys)
        {
            ...
            return keys.Count == 0 ? null : GetUserData(internalUserId, keys[0]);
        }
        ...
        public List<UserItemData> GetAllUserData(long internalUserId)
        {
            ...
            return statement.ExecuteQuery().Select(ReadRow).ToList();
        }
        ...
        {
            var userData = new UserItemData { Key = reader[0].ToString() };
