...
public class XmlReaderExtensionsTests
{
    ...
    {
        // Kodi writes these next to the name. They identify the person, where the spelling only says
        // how this release wrote it down, so dropping them loses the better half of the credit.
