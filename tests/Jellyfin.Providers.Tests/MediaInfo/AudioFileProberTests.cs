...
public class AudioFileProberTests
{
    ...
    [Theory]
    // Taking the first id for everyone would merge the whole credit list into one artist, for good.
    [InlineData("id-a", 2)]
    ...
    {
        // The count lines up but one artist would be handed an empty id.
