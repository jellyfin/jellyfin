...
public class DynamicHlsPlaylistGeneratorTests
{
    ...
    public static TheoryData<int, long, double[]> ComputeEqualLengthSegments_Valid_Success_Data()
    {
        ...
        {
            { 6000, MsToTicks(13000), [6.0, 6.0, 1.0] },
            { 3000, MsToTicks(15000), [3.0, 3.0, 3.0, 3.0, 3.0] },
            { 6000, MsToTicks(25000), [6.0, 6.0, 6.0, 6.0, 1.0] },
            { 6000, MsToTicks(20123), [6.0, 6.0, 6.0, 2.123] },
            { 6000, MsToTicks(1234), [1.234] }
        };
        ...
        {
            {
                ...
                6000, [10.427, 10.427, 10.386, 3.760]
            },
            {
