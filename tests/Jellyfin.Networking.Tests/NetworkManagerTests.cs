...
namespace Jellyfin.Networking.Tests
{
    public class NetworkManagerTests
    {
        ...
        /// always the IPv6 wildcard - whether that socket is dual-mode or IPv6-only is decided by the Kestrel
        /// socket transport setup. Binding the wildcard instead of individual interface addresses also covers
        /// addresses that only show up after startup.
        /// </summary>
