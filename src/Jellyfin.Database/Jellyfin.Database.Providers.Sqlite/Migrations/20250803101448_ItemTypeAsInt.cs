        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 12, "Manual Playlists Folder", "Emby.Server.Implementations.Playlists.PlaylistsFolder" },
                    { 13, "Movie", "MediaBrowser.Controller.Entities.Movies.Movie" },
                    { 14, "Live TV Channel", "MediaBrowser.Controller.LiveTv.LiveTvChannel" },
                    { 15, "Live TV Program", "MediaBrowser.Controller.LiveTv.LiveTvProgram" },
                    ...
                    { 24, "Playlist Folder", "Emby.Server.Implementations.Playlists.PlaylistsFolder" },
                    { 25, "Recording (obsolete?)", "?.Recording" },
                    { 26, "TV Season", "MediaBrowser.Controller.Entities.TV.Season" },
                    { 27, "TV Series", "MediaBrowser.Controller.Entities.TV.Series" },
                    { 28, "Studio", "MediaBrowser.Controller.Entities.Studio" },
                    { 29, "Trailer", "MediaBrowser.Controller.Entities.Trailer" },
                    { 30, "User Root Folder", "MediaBrowser.Controller.Entities.UserRootFolder" },
                    { 31, "User View", "MediaBrowser.Controller.Entities.UserView" },
                    { 32, "Video", "MediaBrowser.Controller.Entities.Video" },
                    { 33, "Year", "MediaBrowser.Controller.Entities.Year" }
                });
