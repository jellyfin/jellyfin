...
#pragma warning restore CS1591 // Missing XML comment for publicly visible type or member
{
    ...
    public void Configure(EntityTypeBuilder<BaseItemKindEntity> builder)
    {
        ...
        builder.HasData(
            ...
            new BaseItemKindEntity { Kind = 12, TypeName = "Emby.Server.Implementations.Playlists.PlaylistsFolder", Description = "Manual Playlists Folder" },
            new BaseItemKindEntity { Kind = 13, TypeName = "MediaBrowser.Controller.Entities.Movies.Movie", Description = "Movie" },
            new BaseItemKindEntity { Kind = 14, TypeName = "MediaBrowser.Controller.LiveTv.LiveTvChannel", Description = "Live TV Channel" },
            new BaseItemKindEntity { Kind = 15, TypeName = "MediaBrowser.Controller.LiveTv.LiveTvProgram", Description = "Live TV Program" },
            ...
            new BaseItemKindEntity { Kind = 24, TypeName = "Emby.Server.Implementations.Playlists.PlaylistsFolder", Description = "Playlist Folder" },
            new BaseItemKindEntity { Kind = 25, TypeName = "?.Recording", Description = "Recording (obsolete?)" },
            new BaseItemKindEntity { Kind = 26, TypeName = "MediaBrowser.Controller.Entities.TV.Season", Description = "TV Season" },
            new BaseItemKindEntity { Kind = 27, TypeName = "MediaBrowser.Controller.Entities.TV.Series", Description = "TV Series" },
            new BaseItemKindEntity { Kind = 28, TypeName = "MediaBrowser.Controller.Entities.Studio", Description = "Studio" },
            new BaseItemKindEntity { Kind = 29, TypeName = "MediaBrowser.Controller.Entities.Trailer", Description = "Trailer" },
            new BaseItemKindEntity { Kind = 30, TypeName = "MediaBrowser.Controller.Entities.UserRootFolder", Description = "User Root Folder" },
            new BaseItemKindEntity { Kind = 31, TypeName = "MediaBrowser.Controller.Entities.UserView", Description = "User View" },
            new BaseItemKindEntity { Kind = 32, TypeName = "MediaBrowser.Controller.Entities.Video", Description = "Video" },
            new BaseItemKindEntity { Kind = 33, TypeName = "MediaBrowser.Controller.Entities.Year", Description = "Year" });
    }
}
