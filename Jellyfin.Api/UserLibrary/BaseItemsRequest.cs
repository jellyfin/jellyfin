...
namespace Jellyfin.Api.UserLibrary
{
    public abstract class BaseItemsRequest : IHasDtoOptions
    {
        ...
        public static ValueTuple<string, SortOrder>[] GetOrderBy(string sortBy, string requestedSortOrder)
        {
            ...
            for (var i = 0; i < vals.Length; i++)
            {
                ...
                var sortOrder = string.Equals(sortOrderValue, "Descending", StringComparison.OrdinalIgnoreCase) ? Jellyfin.Model.Entities.SortOrder.Descending : Jellyfin.Model.Entities.SortOrder.Ascending;
