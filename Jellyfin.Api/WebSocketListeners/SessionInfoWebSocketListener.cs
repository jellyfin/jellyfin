...
public class SessionInfoWebSocketListener : BasePeriodicWebSocketListener<IEnumerable<SessionInfo>, WebSocketListenerState>
{
    ...
    {
        if (message.Connection.AuthorizationInfo.User != null ? !message.Connection.AuthorizationInfo.User.HasPermission(PermissionKind.IsAdministrator) : !message.Connection.AuthorizationInfo.IsApiKey)
        {
