...
namespace Jellyfin.Api.Models.SyncPlay
{
    ...
    public interface IGroupStateContext
    {
        ...
        /// <param name="cancellationToken">The cancellation token.</param>
        /// <returns>The task.</returns>
        Task SendPlaybackCommand(SessionInfo from, SessionsFilterType filter, PlaybackCommandDto message, CancellationToken cancellationToken);
