...
[Authorize]
[Tags("Network")]
public class NetworksController : BaseJellyfinApiController
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="NetworksController"/> class.
    /// </summary>
    ...
    /// <summary>
    /// Gets all networks from a given item, folder, or the entire library.
    /// </summary>
    ...
    /// <response code="200">Networks returned.</response>
    /// <returns>An <see cref="OkResult"/> containing the networks.</returns>
    [HttpGet]
    [ProducesResponseType(StatusCodes.Status200OK)]
    public ActionResult<QueryResult<BaseItemDto>> GetNetworks(
        ...
        [FromQuery] bool enableTotalRecordCount = true)
    {
        ...
        var result = _libraryManager.GetNetworks(query);
    ...
    /// <response code="200">Network returned.</response>
    /// <returns>An <see cref="OkResult"/> containing the network.</returns>
    [HttpGet("{name}")]
    [ProducesResponseType(StatusCodes.Status200OK)]
    public ActionResult<BaseItemDto> GetNetwork([FromRoute, Required] string name, [FromQuery] Guid? userId)
    {
        userId = RequestHelpers.GetUserId(User, userId);
        var dtoOptions = new DtoOptions();

        var item = _libraryManager.GetNetwork(name);
