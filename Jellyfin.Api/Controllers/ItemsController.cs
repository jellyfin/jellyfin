...
public class ItemsController : BaseJellyfinApiController
{
    ...
    /// <param name="networkIds">Optional. If specified, results will be filtered based on network id. This allows multiple, pipe delimited.</param>
    ...
    public async Task<ActionResult<QueryResult<BaseItemDto>>> GetItems(
        ...
        [FromQuery, ModelBinder(typeof(CommaDelimitedCollectionModelBinder))] Guid[] networkIds,
