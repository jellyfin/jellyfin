using Jellyfin.Tests.ConsistencyTests.TextIndexing;
...
namespace Jellyfin.Tests.ConsistencyTests
{
    /// <summary>
    ...
    public class StringUsageReporter
    {
        ...
        /// </remarks>
        public const string WebFolder = @"..\..\..\Jellyfin.WebDashboard\dashboard-ui";
