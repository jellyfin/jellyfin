...
namespace Jellyfin.Controller.Entities
{
    public class UserView : Folder, IHasCollectionType
    {
        ...
        private static string[] UserSpecificViewTypes = new string[]
            {
                Jellyfin.Model.Entities.CollectionType.Playlists
            };
        ...
        private static string[] ViewTypesEligibleForGrouping = new string[]
            {
                Jellyfin.Model.Entities.CollectionType.Movies,
                Jellyfin.Model.Entities.CollectionType.TvShows,
                string.Empty
            };
        ...
        private static string[] OriginalFolderViewTypes = new string[]
            {
                Jellyfin.Model.Entities.CollectionType.Books,
                Jellyfin.Model.Entities.CollectionType.MusicVideos,
                Jellyfin.Model.Entities.CollectionType.HomeVideos,
                Jellyfin.Model.Entities.CollectionType.Photos,
                Jellyfin.Model.Entities.CollectionType.Music,
                Jellyfin.Model.Entities.CollectionType.BoxSets
            };
