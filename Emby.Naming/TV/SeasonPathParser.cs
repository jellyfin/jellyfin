...
namespace Emby.Naming.TV
{
    ...
    {
        [GeneratedRegex(@"^\s*((?<seasonnumber>(?>\d+))(?:st|nd|rd|th|\.)*(?!\s*[Ee]\d+))\s*(?:[[sS](?:eason|æson|aison|taffel|eries|tagione)*|[tT](?:emporada)*|[Сс](?:езон)*)\s*(?<rightpart>.*)$")]
        private static partial Regex ProcessPre();

        [GeneratedRegex(@"^\s*(?:[[sS](?:eason|æson|aison|taffel|eries|tagione)*|[tT](?:emporada)*|[Сс](?:езон)*)\s*(?<seasonnumber>(?>\d+)(?!\s*[Ee]\d+))(?<rightpart>.*)$")]
