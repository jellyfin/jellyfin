...
namespace Emby.Naming.TV
{
    ...
    {
        [GeneratedRegex(@"^\s*((?<seasonnumber>(?>\d+))(?:st|nd|rd|th|\.)*(?!\s*[Ee]\d+))\s*(?:[[sS](?:eason|æson|aison|taffel|eries|tagione)*|[tT](?:emporada)*|[Сc](?:сезон)*)\s*(?<rightpart>.*)$")]
        private static partial Regex ProcessPre();

        [GeneratedRegex(@"^\s*(?:[[sS](?:eason|æson|aison|taffel|eries|tagione)*|[tT](?:emporada)*|[Сc](?:сезон)*)\s*(?<seasonnumber>(?>\d+)(?!\s*[Ee]\d+))(?<rightpart>.*)$")]
