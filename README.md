...
This repository is a hard fork of Emby 3.4.1.18 which eliminates the Premium options and unlocks all included features, as well as includes a Debian package build structure.
