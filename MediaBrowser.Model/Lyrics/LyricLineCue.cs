...
public class LyricLineCue
{
    ...
    /// <param name="width">The count of the characters in the lyric.</param>
    ...
    public LyricLineCue(int position, int width, long start, long end)
    {
        Position = position;
        Width = width;
        Start = start;
    ...
    /// <summary>
    /// Gets the count of the characters in the lyric.
    /// </summary>
