...
public class OidcProviderOptions
{
    ...
    /// </summary>
    public string ProviderId { get; set; } = "authelia";

    /// <summary>
    /// Gets or sets the display name.
    /// </summary>
    public string Name { get; set; } = "Authelia";
    ...
    /// </summary>
    public IReadOnlyList<string> Scopes { get; set; } = new List<string> { "openid", "profile", "email", "groups" };
