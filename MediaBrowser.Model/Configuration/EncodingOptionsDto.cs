...
/// <summary>
/// The encoding options DTO for API use.
/// </summary>
public class EncodingOptionsDto
{
    /// <summary>
    /// Initializes a new instance of the <see cref="EncodingOptionsDto" /> class.
    /// </summary>
    public EncodingOptionsDto()
    {
