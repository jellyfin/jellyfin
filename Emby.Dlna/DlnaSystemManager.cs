...
namespace Emby.Dlna
{
    ...
    /// </summary>
    public class DlnaSystemManager : IServerEntryPoint, IRunBeforeStartup
    {
...
#pragma warning restore IDO0032
        private static DlnaSystemManager? _instance;

        private readonly object _syncLock = new object();
        private readonly IServerConfigurationManager _configurationManager;
        private readonly ILogger<DlnaSystemManager> _logger;
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DlnaSystemManager"/> class.
        /// </summary>
        public DlnaSystemManager(
        ...
        /// </summary>
        public static DlnaSystemManager Instance
        {
            get
            {
                return GetInstance();
        ...
        private static DlnaSystemManager GetInstance()
        {
            if (_instance == null)
            {
                throw new ApplicationException("DlnaSystemManager is not initialised.");
            }
        ...
        {
            await _dlnaProfileManager.InitProfilesAsync().ConfigureAwait(false);
