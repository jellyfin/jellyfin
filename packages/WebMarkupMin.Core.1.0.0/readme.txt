   ...
   ----------------------------------------------------------------------
              README file for Web Markup Minifier: Core 1.0.0
   ...
   =============
   1. Fixed minor bugs;
   2. In configuration settings of the HTML and XHTML minifiers changed
      the default value for `RemoveRedundantAttributes` property (instead
	  of `true` now is used `false`).
