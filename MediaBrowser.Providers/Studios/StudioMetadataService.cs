...
namespace MediaBrowser.Providers.Studios
{
    public class StudioMetadataService : MetadataService<Studio, ItemLookupInfo>
    {
        ...
        /// <inheritdoc />
        protected override void MergeData(MetadataResult<Studio> source, MetadataResult<Studio> target, IEnumerable<MetadataField> lockedFields, bool replaceData, bool mergeMetadataSettings)
        {
