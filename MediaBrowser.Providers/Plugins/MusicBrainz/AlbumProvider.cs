#pragma warning disable CA1001, CS1591
...
namespace MediaBrowser.Providers.Plugins.MusicBrainz
{
    public class AlbumProvider : IRemoteMetadataProvider<MusicAlbum, AlbumInfo>, IHasOrder
    {
        ...
        internal static AlbumProvider Current { get; private set; }
        ...
        internal async Task<HttpResponseMessage> GetMusicBrainzResponse(string url, CancellationToken cancellationToken)
        {
            ...
            try
            {
                ...
                do
                {
                    ...
                    response = await _httpClientFactory.CreateClient(NamedClient.MusicBrainz)
