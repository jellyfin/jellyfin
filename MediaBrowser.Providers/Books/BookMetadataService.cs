...
namespace MediaBrowser.Providers.Books
{
    public class BookMetadataService : MetadataService<Book, BookInfo>
    {
        ...
        /// <inheritdoc />
        protected override void MergeData(MetadataResult<Book> source, MetadataResult<Book> target, IEnumerable<MetadataField> lockedFields, bool replaceData, bool mergeMetadataSettings)
        {
