...
namespace MediaBrowser.Providers.Channels
{
    public class ChannelMetadataService : MetadataService<Channel, ItemLookupInfo>
    {
        ...
        /// <inheritdoc />
        protected override void MergeData(MetadataResult<Channel> source, MetadataResult<Channel> target, IEnumerable<MetadataField> lockedFields, bool replaceData, bool mergeMetadataSettings)
        {
