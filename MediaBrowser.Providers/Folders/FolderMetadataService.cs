...
namespace MediaBrowser.Providers.Folders
{
    public class FolderMetadataService : MetadataService<Folder, ItemLookupInfo>
    {
        ...
        /// <inheritdoc />
        protected override void MergeData(MetadataResult<Folder> source, MetadataResult<Folder> target, IEnumerable<MetadataField> lockedFields, bool replaceData, bool mergeMetadataSettings)
        {
